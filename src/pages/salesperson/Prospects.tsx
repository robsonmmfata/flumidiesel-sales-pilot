        ...
        <Card>
          <CardContent className="py-8 flex flex-col items-center justify-center">
            ...
            <p className="text-gray-500 text-center max-w-md">
              A funcionalidade de prospecção está sendo implementada e estará disponível em breve. 
              Aqui você poderá gerenciar seus potenciais clientes e acompanhar o progresso das negociações.
            </p>
          </CardContent>
        </Card>
      </div>
